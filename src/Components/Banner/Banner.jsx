    ...
    return (
      <div className="py-10">
        <Slider className="max-w-6xl mx-auto" ref={c => (this.slider = c)} {...settings}>
          <div className="bg-blue-50 rounded-lg px-10" key={1}>
            <div className="flex justify-between items-center">
            <div>
            <h3 className="text-6xl font-bold mb-5"><span className="text-blue-800">Give</span> A Little, <br /> Help A <span className="text-blue-800">Lot.</span></h3>
            ...
            <Link to={""} className="flex items-center justify-center rounded-md focus:outline-none h-12 px-5 text-center bg-blue-800 text-white font-semibold hover:bg-blue-600 transition duration-300">
              Get Started
            </Link>
            <Link to={""} className="flex items-center justify-center rounded-md focus:outline-none h-12 px-5 text-center bg-blue-800 text-white font-semibold hover:bg-blue-600 transition duration-300">
              Get Started
            ...
            <div className="py-3 flex justify-between mt-3">
              ...
              <h1 className="text-xl font-bold text-blue-800">Share :</h1>
            ...
            <img className="w-2/5" src="/src/assets/images/Untitled-1.png" alt="" />
        ...
        <div className="mt-10 flex gap-4 justify-center" style={{ textAlign: "center" }}>
          <button className="flex items-center justify-center rounded-md focus:outline-none p-3 text-center border border-gray-300 hover:border-blue-800 font-bold  transition duration-300" onClick={this.previous}>
            <FaAngleLeft></FaAngleLeft>
          </button>
          <button className="flex items-center justify-center rounded-md focus:outline-none p-3 text-center border border-gray-300 hover:border-blue-800 font-bold  transition duration-300" onClick={this.next}>
