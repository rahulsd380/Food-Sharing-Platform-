...
const AddFood = () => {
  const{user} = useContext(AuthContext)
    ...
    const handleSubmit = (e) => {
        ...
        const allData = {email, foodName, foodImage, quantity, location, expireDate, notes, donarName, donarImage, status, donarEmail};
        console.log(allData);

        const toastId = toast.loading("Adding...")
        
    
        fetch('https://food-sharing-server-three.vercel.app/aditional-foods', {
            method : "POST",
            headers : {
    ...
    return (
        <div>
          ...
          <Helmet>
            ...
            <form onSubmit={handleSubmit} className="bg-slate-100 p-10 md:p-10 rounded-r-2xl">
                <h1 className="text-4xl font-bold mb-2 flex items-center gap-4"><BiAddToQueue></BiAddToQueue> Add a new food</h1>
                <p className="mb-7">Please do not waste your food. Insted provide your extra food to those who are starving, who don't have any food to eat.</p>
